        ...
        <>
            <div className="grid grid-cols-12 h-full gap-x-5 justify-between">
                <Files
                    ...
                    clickable
                >
                    <div className="w-full rounded-lg p-10 border-2 border-gray-200/20 border-dashed bg-yellow-300">
                        ...
                        <div className="text-center text-sm">
                            <p className="font-semibold text-2xl">Drag your images here</p>
                            <p className="text-gray-100 mt-3">Drag and drop your files:  {formatList} here.</p>
                            <p className="text-gray-100">Maximum size:: {maxFileSize}MB</p>

                            <div className="text--caption my-2 text-gray-100">- OR -</div>

                            <Button variant="outline" color="gray" className="mx-auto text-gray-100">
